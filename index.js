...
function _search(input, channel, userName) {
  ...
  //Print the result...
  var message = userName + ', I found the following track(s):\n```\n' + trackNames.join('\n') + '\n```\nIf you want to play it, use the `add` command..\n';
...
function _bestof(input, channel, userName) {
  ...
  for (var i = 1; i <= data.artists.items.length; i++) {
    ...
    var uri = data.artists.items[i - 1].uri;
    var external_url = data.artists.items[i - 1].external_urls.spotify;
...
function _searchSpotify(input, channel, userName, limit) {
  ...
  var getapi = urllibsync.request('https://api.spotify.com/v1/search?q=' + query + '&type=track&limit=' + limit + '&market=' + market + '&access_token=' + accessToken);
...
function _searchSpotifyPlaylist(input, channel, userName, limit) {
  ...
  var getapi = urllibsync.request('https://api.spotify.com/v1/search?q=' + query + '&type=playlist&limit=' + limit + '&market=' + market + '&access_token=' + accessToken);
...
function _searchSpotifyAlbum(input, channel, userName, limit) {
  ...
  var getapi = urllibsync.request('https://api.spotify.com/v1/search?q=' + query + '&type=album&limit=' + limit + '&market=' + market + '&access_token=' + accessToken);
...
function _searchSpotifyArtist(input, channel, userName, limit) {
  ...
  var getapi = urllibsync.request('https://api.spotify.com/v1/search?q=' + query + '&type=artist&limit=' + limit + '&market=' + market + '&access_token=' + accessToken);
